...
import {addEqpmntAC, dellEqpmntAC, EqpmntType} from "../../Redux/eqpmnt-reduser";
...
function EquipmentList(props: CustomerCardPropsType) {
    ...
    const delEq = (id: string) => {
        props.store.dispatch(dellEqpmntAC(id))
        setEquipmentState(props.store.getState().Equipment)
    }
